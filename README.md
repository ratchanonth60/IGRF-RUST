...
`v0.4.0` recovers the Magson stream after a lost byte instead of dropping it
silently for the rest of the run, reports output limits that are lopsided
enough to be a typo, stops the loop when the controller link drops - it previously kept
